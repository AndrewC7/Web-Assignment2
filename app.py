...
def favorites_results():
    ...
    return (("Wow, I didn't know %s %ss lived in %s!" % (users_favorite_color, users_favorite_animal, users_favorite_city)))
...
def message_results():
    ...
    return ("Here's your secret message:<br/> %s" % sort_letters(users_secret_message))
...
def horoscope_results():
    ...
    users_personality = request.args.get("HOROSCOPE_PERSONALITIES['horoscope_sign']")
